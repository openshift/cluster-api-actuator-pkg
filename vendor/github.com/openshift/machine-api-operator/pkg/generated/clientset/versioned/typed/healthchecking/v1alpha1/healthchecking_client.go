...
// MachineV1alpha1Client is used to interact with features provided by the machine.openshift.io group.
type MachineV1alpha1Client struct {
	restClient rest.Interface
}

func (c *MachineV1alpha1Client) MachineDisruptionBudgets(namespace string) MachineDisruptionBudgetInterface {
