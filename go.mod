...
require (
	...
	sigs.k8s.io/cluster-api-provider-azure v1.17.1 // indirect
	sigs.k8s.io/cluster-api-provider-gcp v1.8.0 // indirect
	sigs.k8s.io/cluster-api-provider-ibmcloud v0.8.0 // indirect
	sigs.k8s.io/cluster-api-provider-vsphere v1.11.2 // indirect
)
